...
@OnlyIn(Dist.CLIENT)
@Mod.EventBusSubscriber(modid = Geckos.MODID, value = Dist.CLIENT)
public class InGameGeckoHud {

    private static final ResourceLocation BOOK_TEXTURE = GeckoResourceLocation.getFromResources(GeckoResourceLocation.Resources.GECKO_PAPER);
