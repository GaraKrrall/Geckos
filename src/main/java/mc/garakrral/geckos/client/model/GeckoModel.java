...
public class GeckoModel<T extends GeckoEntity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Geckos.MODID, "gecko"), "main");
    ...
    public void renderOnShoulder(PoseStack poseStack,
                                 ...
                                 int tickCount) {
        this.root().getAllParts().forEach(ModelPart::resetPose);
        this.animateWalk(GeckoAnimations.ANIM_GECKO_SLEEP, 0, 0, 1f, 1f);
        this.renderToBuffer(poseStack, buffer, light, overlay, 1, 1, 1, 1);
    }
