...
import mc.garakrral.geckos.entity.client.animation.FlyAnimations;
...
public class FlyModel<T extends FlyEntity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Main.MODID, "fly"), "main");
