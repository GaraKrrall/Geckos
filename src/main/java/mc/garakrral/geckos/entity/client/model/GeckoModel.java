package mc.garakrral.geckos.entity.client.model;
...
import mc.garakrral.geckos.entity.client.animation.GeckoAnimations;
...
public class GeckoModel<T extends GeckoEntity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Main.MODID, "gecko"), "main");
    ...
    public void renderOnShoulder(PoseStack poseStack,
                                 ...
                                 int color) {
        this.root().getAllParts().forEach(ModelPart::resetPose);
        this.renderToBuffer(poseStack, buffer, light, overlay, color);
    }
